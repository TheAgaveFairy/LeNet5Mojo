...
struct FeatureGPU(Copyable, Movable):
    ...
    def __init__(out self, bufs: FeatureGPUBuffers):
        ...
        self.input  = LayoutTensor[ftype, Self.input_layout,  MutAnyOrigin](b_input)
        self.layer1 = LayoutTensor[ftype, Self.layer1_layout, MutAnyOrigin](b_layer1)
        self.layer2 = LayoutTensor[ftype, Self.layer2_layout, MutAnyOrigin](b_layer2)
        self.layer3 = LayoutTensor[ftype, Self.layer3_layout, MutAnyOrigin](b_layer3)
        self.layer4 = LayoutTensor[ftype, Self.layer4_layout, MutAnyOrigin](b_layer4)
        self.layer5 = LayoutTensor[ftype, Self.layer5_layout, MutAnyOrigin](b_layer5)
        self.output = LayoutTensor[ftype, Self.output_layout, MutAnyOrigin](b_output)
